  ...
  const SAMPLE_PARTICIPANTS_NL = [
    {
      ...
      address: { street: 'Hanekerweg', housenumber: '8', postcode: '7381 AM', city: 'Klarenbeek' },
      diet1: null, diet2: 'Vegetarisch',
      hostPreference: 'voorgerecht',
      preferWith: [], avoid: []
    },
    {
      name1: 'Sanne', name2: 'Joost',
      address: { street: 'Klarenbeekseweg', housenumber: '32', postcode: '7382 BB', city: 'Klarenbeek' },
      diet1: 'Glutenvrij', diet2: null,
      hostPreference: 'hoofdgerecht',
      preferWith: [], avoid: []
    },
    {
      name1: 'Peter', name2: 'Anouk',
      address: { street: 'Woudweg', housenumber: '14', postcode: '7383 RC', city: 'Klarenbeek' },
      diet1: null, diet2: null,
      hostPreference: null,
      preferWith: [], avoid: []
    },
    {
      name1: 'Daan', name2: 'Eva',
      address: { street: 'Hessenallee', housenumber: '5', postcode: '7383 RB', city: 'Klarenbeek' },
      diet1: null, diet2: 'Vegan',
      hostPreference: 'nagerecht',
      preferWith: [], avoid: []
    },
    {
      name1: 'Maaike', name2: 'Bram',
      address: { street: 'Hoofdweg', housenumber: '47', postcode: '7381 AT', city: 'Klarenbeek' },
      diet1: null, diet2: null,
      hostPreference: 'voorgerecht',
      preferWith: [], avoid: []
    },
    {
      name1: 'Tim', name2: 'Judith',
      address: { street: 'Veldhuizen', housenumber: '21', postcode: '7382 CD', city: 'Klarenbeek' },
      diet1: 'Lactose-intolerant', diet2: null,
      hostPreference: 'hoofdgerecht',
      preferWith: [], avoid: []
    },
    {
      name1: 'Roos', name2: 'Niels',
      address: { street: 'Molenweg', housenumber: '9', postcode: '7383 AB', city: 'Klarenbeek' },
      diet1: null, diet2: null,
      hostPreference: null,
      preferWith: [], avoid: []
    },
    {
      name1: 'Esther', name2: 'Joep',
      address: { street: 'Bosweg', housenumber: '18', postcode: '7382 BC', city: 'Klarenbeek' },
      diet1: null, diet2: null,
      hostPreference: 'nagerecht',
      preferWith: [], avoid: []
    },
