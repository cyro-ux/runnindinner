...
(function () {
  ...
  const I18N = {
    nl: {
      ...
      modal_body: 'Eigen deelnemers toevoegen, bewerken, printen en Excel-exports zitten in het volledige product. Voor €5 per jaar plan je onbeperkt running dinners — geen abonnement-vallen, geen advertenties.',
    ...
    en: {
      ...
      modal_body: 'Adding/editing your own participants, printing and Excel exports are part of the full product. For €5 a year you can plan unlimited running dinners — no subscription traps, no ads.',
    ...
    es: {
      ...
      modal_body: 'Añadir y editar tus propios participantes, imprimir y exportar a Excel forman parte del producto completo. Por 5 € al año planificas cenas itinerantes sin límite — sin trampas, sin anuncios.',
    ...
    de: {
      ...
      modal_body: 'Eigene Teilnehmer hinzufügen/bearbeiten, Drucken und Excel-Exports sind Teil des Vollprodukts. Für 5 € pro Jahr planst du unbegrenzt Running Dinner — keine Abo-Fallen, keine Werbung.',
  ...
  function applyToState(state) {
    ...
    state.participants = SAMPLE_PARTICIPANTS_NL.map((p, i) => {
      ...
      return {
        ...
        customMinGuests: Number.isFinite(p.customMinGuests) ? p.customMinGuests : null,
        customMaxGuests: Number.isFinite(p.customMaxGuests) ? p.customMaxGuests : null,
        diet1: tDiet(p.diet1),
        diet2: tDiet(p.diet2),
        diet3: tDiet(p.diet3),
